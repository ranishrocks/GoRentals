            ...
            <section id="contact" className="contact mt-5 mb-5">
                        ...
                        <div className="col-lg-4">
                            <div className="info rounded p-3" style={{ background: '#f8f9fa' }}>
                                <div className="d-flex mb-2 gap-2">
                                    ...
                                    <div>
                                        <h4>Location:</h4>
                                        <p>C15, Yamuna Soc, Bhargav Rd, Kubernagar, Saijpur Bogha, Ahmedabad, Gujarat 382340</p>
                                    </div>
                                </div>
                ...
                <div>
                    <div className="container">
                        ...
                        <iframe style={{ border: 0, width: "100%", height: "350px" }} src="https://www.google.com/maps/embed/v1/place?q=Go-Rentals+(Ahmedabad+Bike+rentals),+Bhargav+Road,+Kubernagar,+Saijpur+Bogha,+Ahmedabad,+Gujarat,+India&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
            </section>
            <Footer />
